...
public class DList2 {
  ...
  public void insertEnd(Run i){
      DListNode2 holder = head.prev;
      head.prev = new DListNode2();
      head.prev.item = i;
      head.prev.next = head;
      head.prev.prev = holder;
      head.prev.prev.next = head.prev;
      size++;
    }
    
  public DListNode2 iterate(int i){
      int x = i;
      DListNode2 temp = this.head;
      while (i>-1){
          temp = temp.next;
          i--;
        }
      DListNode2 temp2 = temp.prev;
      while (x > 0){
          temp2 = temp2.prev;
          x--;
        }
